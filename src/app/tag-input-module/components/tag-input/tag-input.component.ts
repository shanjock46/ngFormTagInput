...
// ng2-tag-input
import {TagInputAccessorDirective, TagModel} from '../../core/accessor';
import {listen} from '../../core/helpers/listen';
import * as constants from '../../core/constants';

import {TagComponent, TagInputFormComponent} from '../index';
import {animations} from './animations';
import {defaults} from '../../defaults';

import {NgModalTransformPipe} from '../../core/pipes/ngModalBindTransform';
...
@Component({
  ...
  providers: [CUSTOM_ACCESSOR, NgModalTransformPipe],
  templateUrl: './tag-input.component.html',
  styleUrls: ['./tag-input.component.css'],
  encapsulation: ViewEncapsulation.None,
  animations
})
export class TagInputComponent extends TagInputAccessorDirective implements OnInit, AfterViewInit {
  /**
   * @name separatorKeys
  ...
  constructor(private NgModalTransformFilter: NgModalTransformPipe) {
    super();
  }
  ...
  public handleKeydown(data: any): void {
    ...
    switch (constants.KEY_PRESS_ACTIONS[key]) {
      case constants.ACTIONS_KEYS.DELETE:
        if (!this.selectedTag && data.model && this.items.indexOf(data.model) !== -1) {
          this.selectItem(data.model, true);
        }
